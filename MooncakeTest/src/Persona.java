...
public abstract class Persona {
	...
	public String toString() {
	    return idPersona + ";" + docIdentidad + ";" + complemento + ";" + expedicion + ";" + nombre + ";" + paterno + ";" +
	           materno + ";" + genero + ";" + estadoCivil + ";" + fechaNac + ";" + celular1 + ";" + celular2 + ";" +
	           telefono1 + ";" + telefono2 + ";" + correo + ";" + direccion1 + ";" + direccion2;
	}
	...
	public abstract ArrayList<? extends Persona> leerPersonas();
