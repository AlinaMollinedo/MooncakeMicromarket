...
public class ProductoPeso extends Producto implements Descuento {
    ...
    public ProductoPeso(int cod, String nombre, int cantidad, double precio, String descripcion, LocalDate fechaVencimiento, double pesoPorKilo) {
    ...
    public String toString() {
        return super.toString() + ";ProductoPeso;" + pesoPorKilo;
    }
}